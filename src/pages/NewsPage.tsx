...
export default function NewsPage() {
  ...
  const [activeCategory, setActiveCategory] = useState<NewsCategory['slug']>('tat-ca')
  ...
  return (
    <>
      ...
      <main>
        <NewsPageHero />
        <NewsCategoryFilter activeCategory={activeCategory} onCategoryChange={setActiveCategory} />
        <NewsArticleGrid activeCategory={activeCategory} />
        <FollowSection />
      </main>
      <HomeFooter />
    </>
