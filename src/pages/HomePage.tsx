...
import useScrollTriggeredPopup from '../hooks/useScrollTriggeredPopup'
...
export default function HomePage() {
  ...
  const { isOpen: isContactPopupOpen, close: closeContactPopup } = useScrollTriggeredPopup('anthai-contact-popup', '#tam-bua')
