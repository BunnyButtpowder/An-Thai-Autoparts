    ...
    >
      ...
      <div className="contact-cta-container relative mx-auto flex flex-col items-center px-4 text-center sm:px-6 lg:px-8">
        <h2
          ...
          className="contact-cta-heading contact-cta-reveal text-4xl font-extrabold uppercase tracking-wide leading-15 text-white text-balance sm:text-5xl lg:text-6xl"
        >
        ...
        <div className="contact-cta-actions contact-cta-reveal flex flex-wrap justify-center gap-4 mt-5">
          <Link
            to="/lien-he"
            className="contact-cta-primary inline-flex items-center gap-2 rounded-lg bg-white px-9 py-4 text-lg font-bold text-primary transition-transform duration-300 hover:-translate-y-0.5 cursor-pointer"
          >
            Liên hệ ngay
          ...
          <Link
            to="/gioi-thieu"
            className="contact-cta-secondary inline-flex items-center gap-2 rounded-lg border-[1.5px] border-white/70 px-9 py-4 text-lg font-semibold text-white transition-colors duration-300 hover:bg-white/10 hover:-translate-y-0.5 cursor-pointer"
          >
