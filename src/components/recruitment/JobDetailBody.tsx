  ...
  return (
    <ul className="job-detail-bullet-list flex flex-col gap-3">
      {items.map((item, index) => (
        <li key={index} className="job-detail-bullet-item flex gap-3 text-lg text-foreground/80 leading-relaxed">
  ...
  return (
    <section ref={sectionRef} className="job-detail-body-section bg-background pb-8" id="noi-dung-cong-viec">
      <div className="job-detail-body-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-10">
        <p className="job-detail-block job-detail-summary text-xl text-muted-foreground leading-relaxed">
          {job.summary}
        </p>

        <div className="job-detail-block job-detail-responsibilities">
          <h2 className="job-detail-block-title text-2xl sm:text-3xl font-bold text-foreground mb-4">
            Mô tả công việc
          </h2>
