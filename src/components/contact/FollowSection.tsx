...
const socialIcons: Record<string, ReactNode> = {
  Facebook: (
    <svg className="follow-social-glyph w-5 h-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M24 12.07C24 5.4 18.63 0 12 0S0 5.4 0 12.07c0 6.03 4.39 11.03 10.12 11.93v-8.44H7.08v-3.49h3.04V9.41c0-3.02 1.79-4.69 4.53-4.69 1.31 0 2.68.24 2.68.24v2.97h-1.51c-1.49 0-1.95.93-1.95 1.89v2.25h3.32l-.53 3.49h-2.79V24C19.61 23.1 24 18.1 24 12.07z" />
    </svg>
  ),
  Zalo: (
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="follow-social-glyph w-6 h-6" viewBox="0,0,256,256">
