  ...
  return (
    <section ref={sectionRef} className="follow-section py-20 lg:py-28 text-primary-foreground bg-foreground bg-[radial-gradient(125%_125%_at_50%_100%,color-mix(in_oklab,var(--color-primary)_22%,transparent)_0%,transparent_60%)]" id="theo-doi-chung-toi">
      <div className="follow-container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <p className="follow-label inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 text-white text-sm sm:text-base font-semibold uppercase tracking-widest mb-6">
          Mạng xã hội
        </p>
        <h2 className="follow-heading text-4xl sm:text-5xl lg:text-6xl font-bold text-white uppercase leading-tight">
        ...
        <p className="follow-text text-white text-xl leading-relaxed max-w-2xl mx-auto mb-10">
