        ...
        <div className="product-showcase-card relative overflow-hidden rounded-3xl bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-800 shadow-2xl ring-1 ring-white/10">
          <div className="product-showcase-inner relative grid lg:grid-cols-2 items-center">
            <div className="product-showcase-content relative z-10 p-8 sm:p-10 lg:p-14">
              <span className="product-showcase-badge inline-flex items-center justify-center px-4 py-1.5 text-sm font-semibold uppercase tracking-wider text-white bg-white/10 rounded-full mb-6">
                Made in Vietnam
              </span>
              <h2 className="product-showcase-title text-5xl sm:text-6xl lg:text-7xl font-extrabold text-white leading-tight tracking-tight mb-5">
              ...
              <p className="product-showcase-description text-white/80 text-lg sm:text-xl leading-relaxed max-w-md mb-10">
                Interchangeable with the 3600AX, 3922X, 66864B and more.
              </p>
              <a
                href="lien-he"
                className="product-showcase-cta inline-flex items-center justify-center px-6 py-3 text-base font-semibold text-foreground bg-background hover:bg-background/90 rounded-full transition-colors cursor-pointer"
              >
                Chi tiết
              </a>
            </div>
