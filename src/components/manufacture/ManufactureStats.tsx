...
const stats: Stat[] = [
  ...
  { value: 24000, suffix: '+', unit: 'tấn/năm', label: 'Công suất sản xuất' },
      ...
      <div className="manufacture-stats-container mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:grid-cols-2 sm:gap-x-0 sm:gap-y-10 sm:px-6 lg:px-8">
        {stats.map((stat, index) => (
          <Fragment key={stat.label}>
            ...
            <div
              className={`manufacture-stat border-white/25 ${cellDividers[index]}`}
            >
              <div className="manufacture-stat-value text-5xl font-black leading-none tabular-nums text-white sm:text-6xl lg:text-7xl">
